...
if($res==TRUE)
{
    ...
    $_SESSION['delete']= "<div style='font-size:20px; word-spacing:12px;' class='alert alert-primary text-center fw-bold' role='alert'>Admin Deleted Successfully</div>";
   
    //Preusmjeri na admin stranicu
    header("Location: ../admin/manage_admin2.php");
...
else
{
   ...
   $_SESSION['delete']="<div style='font-size:20px; word-spacing:12px;' class='alert alert-danger text-center fw-bold' role='alert'>Failed to Delete Admin.Try Again Later</div>";
