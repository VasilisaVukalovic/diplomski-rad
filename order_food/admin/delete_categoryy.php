...
<span class="title" style="font-family: 'Dancing Script', cursive; font-size:1.75rem;font-weight:bold; margin-top:5px">Food Delicious</span>
    ...
    <div class="cartBox">
    <h2>Delete<span> category</span></h2>
    
        <div class="cart">

        <p>Do you want to delete the category food?</p>
...
<div class="buttons">
    ...
    width: 35%;
    color: white;
    font-size: 15px;"><a href="delete_category_base.php?id=<?php echo $id?>">Yes</a></button>
    <button class="no" style="padding: 10px;
    width: 35%;
    font-size: 15px;
    color: white;
    background-color: #de705d;"><a href="admin_category.php">No</a></button>
</div>
        </div>
    </div>
</body>
