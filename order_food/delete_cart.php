...
<head>
    ...
    <link rel="stylesheet" href="./admin/style_new/delete_user.css">
...
<span class="title" style="font-family: 'Dancing Script', cursive; font-size:1.75rem;font-weight:bold; margin-top:5px">Food Delicious</span>
    ...
    <div class="cartBox">
    <h2>Delete<span> cart</span></h2>
    
        <div class="cart">

        <p>Are you sure you want to delete your card from the database?</p>
...
<div class="buttons">
    ...
    width: 35%;
    color: white;
    font-size: 15px;"><a href="delete_cart_base.php?id=<?php echo $id;?>">Yes</a></button>
    <button class="no" style="padding: 10px;
    width: 35%;
    font-size: 15px;
    color: white;
    background-color: #de705d;"><a href="cart.php">No</a></button>
</div>
        </div>
    </div>
</body>
